    ...
    const getAssessmentTools = (assessmentType: string, area: string) => {
      const toolMap: { [key: string]: { [key: string]: string[] } } = {
        "Data Hygiene & Business Clarity Diagnostic": {
          "Data Centralization": [
            "Google Workspace for centralized data management",
            "Airtable for flexible business data organization",
            "Notion for comprehensive business documentation"
          ],
          "System Integration": [
            "Zapier for automated data synchronization",
            "Monday.com for workflow and project management",
          ...
          "Lead Tracking": [
            ...
            "Salesforce for comprehensive CRM",
        ...
        "Cash Flow & Financial Clarity Diagnostic": {
          "Profit Tracking": [
            "QuickBooks for comprehensive financial tracking",
            "Wave for free accounting and invoicing",
            "FreshBooks for small business accounting"
          ],
          "Financial Planning": [
            "LivePlan for business planning",
            "PlanGuru for financial forecasting",
            "Float for cash flow management"
          ],
          "Expense Management": [
            "Xero for cloud-based financial management",
            "Mint for personal and business budget tracking",
    ...
    >
      ...
      if (average <= 30) {
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="rounded-lg border border-border p-5 bg-muted/5 shadow-lg mt-0">
        ...
        <div className="space-y-4">
          ...
          {insights.map((insight, index) => (
            <div key={index} className="rounded-lg border border-border hover:border-border/20 p-6 bg-muted/5">
        ...
        <div className="mt-1 z-0">
          ...
          <div className="rounded-lg border border-border p-10 bg-muted/5 shadow-lg flex flex-col items-center w-full mx-auto z-0">
